...
#define RX_Q_SENSOR_FAILURE		0x00002000
#define RX_Q_LAST_KNOWN			0x00004000
...
#define RX_BAD_QUALITY_SENSOR_FAILURE	(RX_BAD_QUALITY|RX_Q_SENSOR_FAILURE)
#define RX_BAD_QUALITY_LAST_KNOWN		(RX_BAD_QUALITY|RX_Q_LAST_KNOWN)
