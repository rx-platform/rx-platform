...
class runtime_model_algorithm
{
  ...
  public:
      ...
      static void reload_runtime (const rx_item_reference& item_reference, rx_result_with_callback<typename typeT::RTypePtr>&& callback);
  ...
  private:
      ...
      static void reload_runtime_sync (const rx_item_reference& item_reference, rx_thread_handle_t result_target, rx_result_with_callback<typename typeT::RTypePtr>&& callback);
