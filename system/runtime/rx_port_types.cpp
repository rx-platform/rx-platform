...
void transport_port::process_stack () const
{
}
...
void physical_port::process_stack () const
{
    ...
    if (id)
    {
        ...
        rx_do_with_callback<rx_result_with<rx_port_ptr>, rx_reference<port_runtime>, rx_node_id>(
            func, RX_DOMAIN_META, [](rx_result_with<rx_port_ptr>&& result)
            {
...
void protocol_port::process_stack () const
{
}
