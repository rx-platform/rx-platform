...
public:
  ...
  private:
      ...
      rx_reference<objects::application_runtime> unassigned_app_;

      rx_reference<objects::application_runtime> system_app_;

      rx_reference<objects::domain_runtime> system_domain_;
