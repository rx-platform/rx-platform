...
class job : private rx::pointers::reference_object  
{
  ...
  private:
	  ...
	  friend void rx_platform::threads::execute_job(void*);
...
public:
  ...
  private:
      ...
      rx::function_to_go<funcT, Args...> function_data_;
...
public:
  ...
  private:
      ...
      rx::result_function_to_go<funcT,resultT,  Args...> function_data_;
...
// Parameterized Class rx_platform::jobs::function_period_job 


// Parameterized Class rx_platform::jobs::function_timer_job 


// Parameterized Class rx_platform::jobs::function_job 


// Parameterized Class rx_platform::jobs::remote_function_job 
