...
protected:
  ...
  public:
      ...
      rx_result bind_socket_udpip_4 (const sockaddr_in* addr, const sockaddr_in* multicast, threads::dispatcher_pool& dispatcher);
...
template <class buffT>
rx_result udp_socket<buffT>::bind_socket_udpip_4 (const sockaddr_in* addr, const sockaddr_in* multicast, threads::dispatcher_pool& dispatcher)
{
    this->dispatcher_data_.handle = rx_create_and_bind_ip4_udp_socket(addr, multicast);
