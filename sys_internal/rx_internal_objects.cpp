...
system_application::system_application()
	: application_runtime(runtime::object_types::application_creation_data{ RX_NS_SYSTEM_APP_NAME, RX_NS_SYSTEM_APP_ID, RX_NS_SYSTEM_APP_TYPE_ID, true })
{
	init_object();
}
...
system_domain::system_domain()
	: domain_runtime(runtime::object_types::domain_creation_data{ RX_NS_SYSTEM_DOM_NAME, RX_NS_SYSTEM_DOM_ID, RX_NS_SYSTEM_DOM_TYPE_ID, true, runtime::rx_application_ptr::null_ptr })
{
	init_object();
}
...
unassigned_application::unassigned_application()
	: application_runtime(runtime::object_types::application_creation_data{ RX_NS_SYSTEM_UNASS_APP_NAME, RX_NS_SYSTEM_UNASS_APP_ID, RX_NS_SYSTEM_UNASS_APP_TYPE_ID })
{
	init_object();
}
...
unssigned_domain::unssigned_domain()
	: domain_runtime(runtime::object_types::domain_creation_data{ RX_NS_SYSTEM_UNASS_NAME, RX_NS_SYSTEM_UNASS_ID, RX_NS_SYSTEM_UNASS_TYPE_ID, true, runtime::rx_application_ptr::null_ptr } )
{
