...
rx_result rx_platform_builder::build_platform (hosting::rx_platform_host* host, namespace_data_t& data, const meta::meta_configuration_data_t& meta_data, rx_internal::internal_ns::platform_root::smart_ptr root)
{
