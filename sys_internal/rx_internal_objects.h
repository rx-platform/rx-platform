...
class system_application : public rx_platform::objects::object_types::application_runtime  
{
...
class system_domain : public rx_platform::objects::object_types::domain_runtime  
{
	DECLARE_CODE_INFO("rx", 0,5,1, "\
...
class unassigned_application : public rx_platform::objects::object_types::application_runtime  
{
	DECLARE_CODE_INFO("rx", 0,5,1, "\
...
class unssigned_domain : public rx_platform::objects::object_types::domain_runtime  
{
	DECLARE_CODE_INFO("rx", 0,5,1, "\
